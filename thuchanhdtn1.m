...
plot(data),title('data'),axis([0 Ns -1.1 1.1]),xlabel('Number of bit'),ylabel('Amplitude'),pause,
end
%------------------------------------------------
%MODULATION
%BPSK signal
...
%index k is for SNRs
% Tính BER c?a m?i SNR trong Nmax l?n loop
